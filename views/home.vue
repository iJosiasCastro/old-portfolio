  ...
  <div>
    <Layout :data="data">
      <div class="max-w-2xl mx-auto p-2">
        ...
        <div class="text-center">
          <div class="flex flex-col items-center">
            ...
            <img
              class="h-8 w-8 -mr-16 -mt-6 mb-6"
              src="/img/svg/argentina_flag.svg"
              alt=""
            />
          </div>
          <div class="max-w-md mx-auto">
            <h1
              class="text-xl sm:text-3xl mb-3"
              v-html="data.home_presentation_title"
            ></h1>
      ...
      <div>
        ...
        <div class="bg-blue-700 text-white py-28">
          <div class="max-w-2xl mx-auto text-center md:text-lg px-2">
